...
(function(){
  ...
  function mountQuiz(){
    ...
    if(!bar || !qwrap || !bubbles || !leftL || !rightL || !prev || !next){ console.warn('quiz DOM incomplete'); return; }
  ...
  function mountResult(){
    ...
    const t = window.AFFINIA_TYPES.find(v=>v.code===code) || window.AFFINIA_TYPES[0];
  ...
  document.addEventListener('DOMContentLoaded',()=>{ try{ setupNav(); mountQuiz(); mountResult(); }catch(e){ console.error(e); } });
})();
